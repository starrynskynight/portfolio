...
<head>
    ...
    align-items: center;
        ...
        .container_4 {
            background: linear-gradient(to right, #0D1117, #0B132B, #1B263B);
        }
        .container_5 {
        ...
        .container_6 {
            background: linear-gradient(to left, #0D1117, #0B132B, #1B263B);
        }
        .container_9 {
...
<nav style="background-color: #091f39;" class="dark:bg-gray-900 fixed w-full z-50 top-0 left-0 border-b border-blue-800 dark:border-gray-600">
    <div class="w-full flex flex-wrap items-center justify-between mx-auto p-4">
        <a class="flex items-center space-x-3 rtl:space-x-reverse">
            <img src="{{ asset('images/ladyyy.jpg') }}" class="h-10 rounded-full" alt="Logo Kucing">
        ...
        <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1 " id="navbar-sticky" style="background-color: #091f39;">
                ...
                <li>
                    <a href="{{ route('life') }}" class="block py-2 px-3 text-white rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">My Projects</a>
                </li>
            </ul>
        </div>
    </div>
